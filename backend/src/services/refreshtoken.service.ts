...
import {RefreshTokenRepository, MyUserRepository} from '../repositories';
import {securityId, TokenObject, UserProfile} from '../types';
...
export class RefreshtokenService {
  ...
  async refreshToken(refreshToken: string): Promise<TokenObject> {
    try {
      ...
      const userId = Number(userRefreshData.userId); // Ensure userId is a number
